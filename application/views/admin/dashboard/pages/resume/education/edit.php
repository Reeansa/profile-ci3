...
<div class="card mb-4">
    ...
    <div class="card-body">
        <?= form_open_multipart( 'admin/pages/education/edit_process/'.$education['ideducation'] ) ?>
        <div class="row mb-3">
            <label class="col-sm-2 col-form-label" for="name">name</label>
            <div class="col-sm-10">
                <input type="text" name="name" class="form-control" id="name" value="<?= $education[ 'name' ] ?>">
            </div>
        </div>
        <div class="row mb-3">
            <label class="col-sm-2 col-form-label" for="dateStart">date start</label>
            <div class="col-sm-10">
                <input type="date" name="dateStart" id="dateStart" class="form-control" value="<?= $education[ 'date_start' ] ?>">
            </div>
        </div>
        <div class="row mb-3">
            <label class="col-sm-2 col-form-label" for="dateEnd">date end</label>
            <div class="col-sm-10">
                <input type="date" name="dateEnd" id="dateEnd" class="form-control" value="<?= $education[ 'date_end' ] ?>">
            </div>
        </div>
        <div class="row mb-3">
            <label class="col-sm-2 col-form-label" for="description">description</label>
            <div class="col-sm-10">
                <textarea type="date" name="description" id="description" class="form-control"><?= $education[ 'description' ] ?></textarea>
            </div>
        </div>
        <div class="row mb-3">
